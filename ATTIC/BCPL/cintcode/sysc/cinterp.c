...
(c) Copyright:  Martin Richards  December 2018
...
// GW gets a 32 bit value from Cintcode byte address x
// On 64 bit BCPL this is unsigned. On a 32 bit system
...
{  default:
   ...
   case F_selst: // SLCT len:sh:0 OF <arg1> op:= <arg2>
	 ...
	 //printf("=> %13.5f\n", t);
       ...
       //       op, len, sh, UWD oldval, UWD val, UWD mask);
