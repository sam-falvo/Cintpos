// This will be and extended(?) version of the OCODE to Cintcode
// codegenerator.

// Implemented by Martin Richards (c) July 2010


/* Change history
20/07/10
Implemented the OF, floating point and op:= extensions, ie the
OCODE statements SELLD, SELST and FLTOP.
