/*
This defined the function drawtegermoth() used by fltiger.b
It has been modified to use floating point number.
...
LET drawtigermoth() BE
{
  ...
  { // Aileron deflection 1 inch from hinge
    LET a = 0.600 #* c_aileron #/ 17.0   // c_airleron is between #-1.0 and 1.0

    setcolour(maprgb(155,155,20))               // Under surface
    cdrawquad3d(#-4.396,       6.000, #-1.745,  // Panel D Aileron
                #-5.546+3#*a,  6.000, #-1.821#-0.014#*a,
                #-6.297+3#*a, 13.766, #-1.255#-0.014#*a,
                #-5.147,      14.166, #-1.179)
  }
  ...
  { // Aileron deflection 1 inch from hinge
    LET a = 0.600 #* c_aileron #/ 17

    setcolour(maprgb(120,140,60))
    cdrawquad3d(#-4.396,       6.000, #-1.645,  // Panel D Aileron
                #-5.546#+0.003#*a,  6.000, #-1.821#-0.014#*a,
                #-6.297#+0.003#*a, 13.766, #-1.255#-0.014#*a,
                #-5.147,          14.166, #-0.979)
  }
  ...
  { // Rudder deflection 1 inch from hinge
    LET a = 1.100 #* c_rudder #/ 17.0

    setcolour(maprgb(170,180,80))
    cdrawquad3d(#-14.000, 0.000,   0.0,   // Fin
                #-16.000, 0.000,   0.0,
                #-16.000, 0.000, 1.000,
                #-15.200, 0.000, 1.000)
    
    setcolour(maprgb(70,120,40))
    cdrawquad3d(#-15.200#-0.003#*a,   0.009#*a, 1.000,  // Rudder
                #-16.000,             0.0,      1.000,
                #-16.800#+0.003#*a, #-0.010#*a, 3.100,
                #-16.000,             0.0,      2.550)
    setcolour(maprgb(70, 80,40))
    cdrawquad3d(#-16.000,             0.0,      1.000,
                #-16.800#+0.003#*a, #-0.010#*a, 3.100,
                #-17.566#+0.004#*a, #-0.014#*a, 2.600,
                #-17.816#+0.004#*a, #-0.017#*a, 1.667)
    setcolour(maprgb(70,120,40))
    cdrawquad3d(#-16.000,             0.0,      1.000,
                #-17.816#+0.004#*a, #-0.017#*a, 1.667,
                #-17.816#+0.004#*a, #-0.017#*a, 1.000,
                #-17.566#+0.004#*a, #-0.014#*a, 0.0)
    setcolour(maprgb(70, 80,40))
    cdrawquad3d(#-16.000,             0.0, 1.000,
                #-17.566#+0.004#*a, #-0.014#*a,   0.0,
                #-17.000#+0.002#*a, #-0.008#*a, #-0.583,
                #-16.000,             0.0,      #-0.667)

    // Tail skid
    setcolour(maprgb(20, 20,20))
    cdrawquad3d(#-16.000,             0.0,      #-0.667,
                #-16.200,             0.0,      #-0.667,
                #-16.500#+0.002#*a, #-0.008#*a, #-0.900,
                #-16.300#+0.002#*a, #-0.007#*a, #-0.900)

  }

  // Tailplane and elevator
  { // Elevator deflection 1 inch from hinge
    LET a = 0.600 #* c_elevator #/ 17.0

    setcolour(maprgb(160,200,50)) 
    cdrawquad3d(#-16.000, 0.000,     0.0, // Left tailplane
                #-13.900, 0.600,     0.0,
                #-14.600, 2.800,     0.0,
                #-16.000, 4.500,     0.0)

    setcolour(maprgb(120,200,50))
    cdrawtriangle3d(#-13.900,   0.600,     0.0,
                    #-13.900, #-0.600,     0.0,
                    #-16.000,   0.000,     0.0)

    cdrawquad3d(#-16.000,   0.000,     0.0, // Right tailplane
                #-13.900, #-0.600,     0.0,
                #-14.600, #-2.800,     0.0,
                #-16.000, #-4.500,     0.0)

    setcolour(maprgb(170,150,80)) 
    cdrawquad3d(#-16.000,           0.000,   0.0, // Left elevator
                #-17.200#+0.004#*a, 0.600, #-0.015#*a, // pt 1
                #-17.500#+0.005#*a, 0.900, #-0.016#*a, // pt 2
                #-17.666#+0.005#*a, 2.000, #-0.017#*a) // pt 3

    setcolour(maprgb(120,170,60)) 
    cdrawquad3d(#-16.000,           0.000,   0.0, // Left elevator
                #-17.666#+0.005#*a, 2.000, #-0.017#*a, // pt 3
                #-17.450#+0.004#*a, 3.500, #-0.016#*a, // pt 4
                #-17.200#+0.004#*a, 4.650, #-0.014#*a) // pt 5

    setcolour(maprgb(160,120,40)) 
    cdrawquad3d(#-16.000,      0.000,    0.0, // Left elevator
                #-17.200+4#*a, 4.650,  #-0.014#*a, // pt 5
                #-16.700+a/2,  4.833,  #-0.002#*a, // pt 6
                #-16.000,      4.500,     a) // pt 7

    setcolour(maprgb(170,150,80)) 
    cdrawquad3d(#-16.000, 0.000,     0,     // Right elevator
                #-17.200+4#*a,#-0.600, #-0.015#*a, // pt 1
                #-17.500+5#*a,#-0.900, #-0.016#*a, // pt 2
                #-17.666+5#*a,#-2.000, #-0.017#*a) // pt 3

    setcolour(maprgb(120,170,60)) 
    cdrawquad3d(#-16.000,             0.000,   0.0, // Right elevator
                #-17.666#+0.005#*a, #-2.000, #-0.017#*a, // pt 3
                #-17.450#+0.004#*a, #-3.500, #-0.016#*a, // pt 4
                #-17.200#+0.004#*a, #-4.650, #-0.014#*a) // pt 5
    ...
    cdrawquad3d(#-16.000,            0.000,    0.0, // Right elevator
                #-17.200#+0.004#*a,#-4.650,  #-0.014#*a, // pt 5
                #-16.700#+a/2.0,   #-4.833,  #-0.002#*a, // pt 6
                #-16.000,          #-4.500,     a) // pt 7
  }
}
