/*
This is a GET file containing the defininition of the
function drawtigermoth() used by draw3d.b and tiger.b
...
12/03/2018
Modified to use floating point and the FLT feature.
...
LET drawtigermoth(elevator, aileron, rudder) BE
{
  // Cockpit floor
  ...
  setcolour(maprgb(80,80,80))
  cdrawquad3d( -4.500,  10.000, -1.270,
               -4.750,  10.000, -1.270,
               -2.850,  10.000,  3.195,
               -2.500,  10.000,  3.195)
...
*/
  ...
  { // Elevator deflection 1 inch from hinge
    ...
    cdrawquad3d(-16.000,      0.000, 0.000, // Left elevator
                -17.200+4*aa, 0.600, -15*a, // pt 1
                -17.500+5*aa, 0.900, -16*a, // pt 2
                -17.666+5*aa, 2.000, -17*a) // pt 3

    setcolour(maprgb(120,170,60)) 
    cdrawquad3d(-16.000,      0.000, 0.000, // Left elevator
                -17.666+5*aa, 2.000, -17*a, // pt 3
                -17.450+4*aa, 3.500, -16*a, // pt 4
                -17.200+4*aa, 4.650, -14*a) // pt 5

    setcolour(maprgb(160,120,40)) 
    cdrawquad3d(-16.000,      0.000, 0.000, // Left elevator
                -17.200+4*aa, 4.650, -14*a, // pt 5
                -16.700+aa/2, 4.833,  -2*a, // pt 6
                -16.000,      4.500,     a) // pt 7
...
AND wheel(FLT tpos, FLT wpos, FLT lpos) BE
{ setcolour(60,20,20)
  //            t             w        l
  cdrawquad3d( tpos,       wpos+0.200, lpos,      // top back left
               tpos-0.500, wpos+0.250, lpos,
               tpos-0.350, wpos+0.250, lpos+0.350,
               tpos,       wpos+0.250, lpos+0.500)
  cdrawquad3d( tpos-0.500, wpos+0.250, lpos,
               tpos-0.650, wpos,       lpos,
               tpos-0.500, wpos,       lpos+0.500,
               tpos-0.350, wpos+0.250, lpos+0.350)
  cdrawquad3d( tpos-0.350, wpos+0.250, lpos+0.350,
               tpos-0.500, wpos,       lpos+0.500,
               tpos,       wpos,       lpos+0.650,
               tpos,       wpos+0.250, lpos+0.500)

  cdrawquad3d( tpos,       wpos-0.200, lpos,       // top back right
               tpos-0.500, wpos-0.250, lpos,
               tpos-0.350, wpos-0.250, lpos+0.350,
               tpos,       wpos-0.250, lpos+0.500)
  cdrawquad3d( tpos-0.500, wpos-0.250, lpos,
  ...
  cdrawquad3d( tpos,       wpos+0.200, lpos,      // top front left
               tpos+0.500, wpos+0.250, lpos,
               tpos+0.350, wpos+0.250, lpos+0.350,
               tpos,       wpos+0.250, lpos+0.500)
  cdrawquad3d( tpos+0.500, wpos+0.250, lpos,
  ...
  cdrawquad3d( tpos,       wpos-0.200, lpos,       // top front right
               tpos+0.500, wpos-0.250, lpos,
               tpos+0.350, wpos-0.250, lpos+0.350,
               tpos,       wpos-0.250, lpos+0.500)
  cdrawquad3d( tpos+0.500, wpos-0.250, lpos,
  ...
  cdrawquad3d( tpos,       wpos+0.200, lpos,      // bottom back left
               tpos-0.500, wpos+0.250, lpos,
               tpos-0.350, wpos+0.250, lpos-0.350,
               tpos,       wpos+0.250, lpos-0.500)
  cdrawquad3d( tpos-0.500, wpos+0.250, lpos,
  ...
  cdrawquad3d( tpos,       wpos-0.200, lpos,       // bottom back right
               tpos-0.500, wpos-0.250, lpos,
               tpos-0.350, wpos-0.250, lpos-0.350,
               tpos,       wpos-0.250, lpos-0.500)
  cdrawquad3d( tpos-0.500, wpos-0.250, lpos,
  ...
  cdrawquad3d( tpos,       wpos+0.200, lpos,      // bottom front left
               tpos+0.500, wpos+0.250, lpos,
               tpos+0.350, wpos+0.250, lpos-0.350,
               tpos,       wpos+0.250, lpos-0.500)
  cdrawquad3d( tpos+0.500, wpos+0.250, lpos,
  ...
  cdrawquad3d( tpos,       wpos-0.200, lpos,       // bottom front right
               tpos+0.500, wpos-0.250, lpos,
               tpos+0.350, wpos-0.250, lpos-0.350,
               tpos,       wpos-0.250, lpos-0.500)
  cdrawquad3d( tpos+0.500, wpos-0.250, lpos,
