...
IF FALSE DO
FOR i = 1 TO 5 DO // Testing for an apparent bug
{ writef("i=%n*n", i)
  abort(1234)
}
  sdldelay(4_500) // Pause for 4.5 secs There seems to be
                  // a SDL problem if the delay is longer
		  // than 5 secs. This problem is new,
		  // hopefully using SDL2 will solve it.
  closesdl()      //Quit SDL
