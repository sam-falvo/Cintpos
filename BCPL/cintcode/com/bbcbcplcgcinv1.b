...
// converted to work with the front end that compiles BBC
// BCPL for the BBC Microcomputer.

// Implemented by Martin Richards (c) 1 December 2019.

/* Change history

01/12/2019
Started the changes needed for the BBC BCPL to 32 bit Cintcode
compiler.
