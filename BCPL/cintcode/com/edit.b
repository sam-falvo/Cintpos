...
This is essentially a Tripos text editor designed for used by
terminals such as teletypes. It was implemented in in the late 1960s
mainly by Adrian Aylward. It was one of the main text editors used by
Tripos users at that time. This version has been modified by
M.Richards to run under modern Cintcode BCPL.
...
15/4/2019
Systematically modified for the cintsys system. It has not yet
been fully debugged.


The editor is entered using a command of the following form:
...
Examples:       edit prog.b
                edit prog.b to newprog.b
