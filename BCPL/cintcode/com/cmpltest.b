...
//writef("Test SWITCHON 4*n")
  ...
  testno := 4000  // Test expression operator precedence

  wrs("Testing expression operator precedence*n")
  { LET a0, a1, a2, a3 = 0, 1, 2, 3
    LET p = @ a0
    //wrs("SLCT t(11,11):6:7*n"); wrx(SLCT t(11,11)); nl()
    t( 10-1-1, 8)
