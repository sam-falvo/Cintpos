...
fin:
    ...
    IF linking DO
    {
        ...
        LET r = ?
        v%0 := 0
        appendcstring(v, "gcc -z noexecstack ")
    ...
    elapsedtime := (t2!0-t1!0) * 1000 + (t2!1 - t1!1) / 1000  // millisecs
    writef("Compilation %i3.", elapsedtime / 1000)
    elapsedtime := elapsedtime MOD 1000
    TEST elapsedtime < 10
    THEN writef("00%i1 s*n", elapsedtime)
    ELSE
      TEST elapsedtime < 100
      THEN writef("0%i2 s*n", elapsedtime)
      ELSE writef("%i3 s*n", elapsedtime) 
