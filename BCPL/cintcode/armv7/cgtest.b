...
Last updated by Martin Richards (c) June 2013
...
{ testcount := testcount + 1
  ...
  TEST x=y
  THEN writes("OK")
  ELSE { writehex(x, (on64->16,8)); writes(" FAILED*n")
         writes("It should be "); writed(y, (on64->21,13))
         wrch(' '); writehex(y, (on64->16,8))
...
{ LET ww = 65
  ...
  writes("The BCPL word is ")
  writed(bitsperword, 0)
  writes(" bits long*n*n")
//abort(1000)    
  tester(0, 1, 2, v1, v2)
...
l1:
  ...
  testmuldiv(+#x87654321,+#x12345678,+#x23456789)    //3001
  testmuldiv(-#x87654321,+#x12345678,+#x23456789)    //3002
  testmuldiv(+#x87654321,-#x12345678,+#x23456789)    //3003
  testmuldiv(-#x87654321,-#x12345678,+#x23456789)    //3004
  testmuldiv(+#x87654321,+#x12345678,-#x23456789)    //3005
  testmuldiv(-#x87654321,+#x12345678,-#x23456789)    //3006
  testmuldiv(+#x87654321,-#x12345678,-#x23456789)    //3007
  testmuldiv(-#x87654321,-#x12345678,-#x23456789)    //3008

  testno := 3100
  // Test static minus one
  t(minus1, -1)

  newline()
  writen(testcount)
  writes(" TESTS COMPLETED, ")
  writen(failcount)
  writes(" FAILURE(S)*N")
}
...
AND testmuldiv(x, y, z, a, r) BE TEST on64
  THEN tmd(x<<32, y<<32, z<<32, a)
  ELSE tmd(x, y, z)

AND tmd(x, y, z) BE
{ //LET a1 = sys(Sys_muldiv,x, y, z)
  LET a1 = muldiv(x, y, z)
  LET r1 = result2
  //writef("%16x %16x %16x*n", x,y,z)
  { // Check that x = (az+r)y
    //LET t1 = sys(Sys_muldiv, a1, z, y)
    LET t1 = muldiv(a1,z,y)
    LET t2 = (r1+result2)/y
//writef("tmd: r1=%16x result2=%16x*n", r1, result2)
    //UNLESS x = t1+t2 DO
    //  writef("Bad result x=%16x  t1=%16x t2=%16x*n", x, t1, t2)
    t(t1+t2, x)
  }
}
